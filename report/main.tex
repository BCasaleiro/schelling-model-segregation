...
it reaches $0.4$ the segregation increases sizably even though the agents don't mind being near 60\% of agents from other
...
satisfy all agents and will almost always be some unsatisfied ones.
